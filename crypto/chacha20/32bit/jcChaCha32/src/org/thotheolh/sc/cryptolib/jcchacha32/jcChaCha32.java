 ...
 * @author Thotheolh
 */
public class jcChaCha32 extends Applet {
            ...
            if (buffer[ISO7816.OFFSET_INS] == (byte) 0xDA) {
                ...
                if (buffer[ISO7816.OFFSET_P1] == (byte) 0x01) {
                    if ((buffer[ISO7816.OFFSET_LC] & 0xFF) > 48) {
                        ...
                        Util.arrayCopyNonAtomic(buffer, (short) 53, b1, (short) 0, sBuff[0]);
                    ...
                    if ((buffer[ISO7816.OFFSET_LC] & 0xFF) > 48) {
                        ...
                        // Copy counter
                        Util.arrayCopyNonAtomic(buffer, (short) 17, counter, (short) 0, (short) 17);
